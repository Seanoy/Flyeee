...
/*机体到地球*/
void imuTransformVectorBodyToEarth(axis3f_t * v)
{
...
/*地球到机体*/
void imuTransformVectorEarthToBody(axis3f_t * v)
{
    v->y = -v->y;
...
void imuUpdate1(axis3f_t acc, axis3f_t gyro, state_t *state, float dt)
{
